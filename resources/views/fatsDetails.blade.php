...
<head>
    ...
    <title>Healthy Fats Details</title>
...
<body>
    ...
    <div class="container my-5">
        <h1 class="mb-4">Source of Healthy Fats</h1>
        <img src="https://i.pinimg.com/originals/ad/d7/21/add721a7e63ed7f93765f805fafa4d85.jpg" class="img-fluid mb-4" alt="Source of Healthy Fats">
        <p>Healthy fats are essential for maintaining cell structure, supporting brain function, and reducing inflammation in the body.</p>
        <h2>Benefits of Healthy Fats</h2>
        <ul>
            <li>Improves heart health by increasing good cholesterol levels (HDL).</li>
            <li>Supports brain health and cognitive function.</li>
            <li>Provides energy and helps absorb fat-soluble vitamins (A, D, E, K).</li>
        </ul>
        <p>Incorporate healthy fats into your diet through foods like avocados, nuts, seeds, fatty fish, and olive oil.</p>
    </div>
