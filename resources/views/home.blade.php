...
<head>
    ...
    <link rel="icon" href="/public/image/justLogo.png">
    <style>
        * {
...
<body>
    ...
    <nav class="navbar navbar-expand-lg" style="background-color:#113826">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('home') }}" style="color: white;"> <img src="{{asset('/public/image/logo.png')}}" alt="" style="max-width: 120px;"></a>
